...
const Cart = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-24 mt-12">
      ...
      <h1 className="text-2xl font-bold mb-4 flex justify-center items-center">Shopping Cart</h1>
      {cart.length === 0 ? (
              ...
              return (
                <div
                  ...
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-20 h-20 sm:w-24 sm:h-24 object-cover mr-4 rounded lg:w-16 lg:h-18 md:w-16 md:h-18 "
                  />
                  <div className="grow">
